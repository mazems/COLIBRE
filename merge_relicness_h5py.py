...
def main():
    ...
    parser.add_argument("--pattern", default="relicness_*.csv", help="glob pattern to find relicness csv files")
    parser.add_argument("--exclude", nargs="*", default=DEFAULT_EXCLUDE, help="filenames to exclude (basename match)")
    parser.add_argument("--out", default="relicness_merged.csv", help="output merged CSV filename")
