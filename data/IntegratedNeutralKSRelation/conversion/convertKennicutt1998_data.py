...
plot_as = "points"
name = (
    "Galaxy-averaged H2+HI Gas Surface Density vs Star "
...
data = np.loadtxt(
    ...
    usecols=(4, 5),
    dtype=[("Sigma_gas", np.float32), ("Sigma_star", np.float32)],
)

Sigma_gas = unyt.unyt_array(10.0 ** data["Sigma_gas"], "Msun/pc**2")
Sigma_star = unyt.unyt_array(10.0 ** data["Sigma_star"], "Msun/yr/kpc**2")

processed.associate_x(
    Sigma_gas, scatter=None, comoving=False, description="H2+HI Surface density"
)
